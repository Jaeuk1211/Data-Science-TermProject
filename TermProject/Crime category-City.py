...
dataframe = dataframe[['Police District Name', 'City', 'Crime Name1']]

dataframe.dropna(axis=0, inplace=True)

encoder = skpp.OrdinalEncoder()

encoder.fit(dataframe[['Police District Name']])
dataframe[['Police District Name']] = encoder.transform(dataframe[['Police District Name']])

encoder.fit(dataframe[['City']])
dataframe[['City']] = encoder.transform(dataframe[['City']])


feature_name = ['Police District Name', 'City']
X = dataframe[feature_name]
y = dataframe['Crime Name1']
